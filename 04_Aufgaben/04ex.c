...
Canvas draw_circle(Canvas c, int x, int y, int diameter) {
  ...
  if (diameter % 2 == 0) {
    draw_odd_circle(c, centerX - 1, centerY - 1, radius - 1);
    draw_odd_circle(c, centerX, centerY, radius - 1);
    draw_odd_circle(c, centerX - 1, centerY, radius - 1);
    draw_odd_circle(c, centerX, centerY - 1, radius - 1);
  } else {
    draw_odd_circle(c, centerX, centerY, radius);
  }
  return c;
}
